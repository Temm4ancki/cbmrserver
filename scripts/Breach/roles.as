...
namespace Roles
{
	...
	void Initialize()
	{
		...
		Role@ ClassD = Role(ROLE_CLASS_D, "Класс-Д", CATEGORY_INMATE, PlayerModel(CLASS_D_MODEL), Color(212,113,0), "Найди оружие. Сбеги из комплекса. Не доверяй никому.",
		{
		...
		Role@ Janitor = Role(ROLE_JANITOR, "Уборщик", CATEGORY_STAFF, PlayerModel(CLASS_D_MODEL, {JANITOR_TEXTURE}), Color(150,113,0), "Найди помощь. Сбеги из комплекса. Не доверяй никому.",
		{
			Spawnpoint(vector3(0.0, 78, 0.0), 0.0, 0.0, world.GetRoomByIdentifier(r_room2_js))
		}, {"Level 0 Key Card"});
		
		Role@ Scientist = Role(ROLE_SCIENTIST, "Учёный", CATEGORY_STAFF, 
		...
		Role@ Guard = Role(ROLE_GUARD, "Охранник", CATEGORY_SECURITY, PlayerModel(GUARD_MODEL), Color(20, 20, 200), "Найди и спаси учёных. Арестуй или нейтрализуй Класс-Д.",
		{ 
		...
		Role@ MTF = Role(ROLE_MTF, "Рекрут Мобильной Оперативной Группы", CATEGORY_SECURITY, PlayerModel(MTF_MODEL, {MTF_TEXTURE}), Color(20, 20, 200), "Найди и спаси учёных. Арестуй или нейтрализуй Класс-Д.",
		{ 
		...
		Role@ MTFMed = Role(ROLE_MTF_MEDIC, "Медик Мобильной Оперативной Группы", CATEGORY_SECURITY, PlayerModel(MTF_MODEL, {MTF_MEDIC_TEXTURE}), Color(20, 20, 200), "Найди и спаси учёных. Арестуй или нейтрализуй Класс-Д.",
		{ 
			Spawnpoint(vector3(frand(4000.0, 4800.0), 50, frand(-5300.0, -4600.0)), 0.0, 0.0, gate_b),
			Spawnpoint(vector3(frand(4000.0, 4800.0), 50, frand(-5300.0, -4600.0)), 0.0, 0.0, gate_b),
			Spawnpoint(vector3(frand(4000.0, 4800.0), 50, frand(-5300.0, -4600.0)), 0.0, 0.0, gate_b),
		...
		Role@ MTFSer = Role(ROLE_MTF_SERGEANT, "Сержант Мобильной Оперативной Группы", CATEGORY_SECURITY, PlayerModel(MTF_MODEL, {MTF_SERGEANT_TEXTURE}), Color(20, 20, 200), "Найди и спаси учёных. Арестуй или нейтрализуй Класс-Д. Командуй своим отрядом.",
		{ 
			Spawnpoint(vector3(frand(4000.0, 4800.0), 50, frand(-5300.0, -4600.0)), 0.0, 0.0, gate_b),
			Spawnpoint(vector3(frand(4000.0, 4800.0), 50, frand(-5300.0, -4600.0)), 0.0, 0.0, gate_b),
			Spawnpoint(vector3(frand(4000.0, 4800.0), 50, frand(-5300.0, -4600.0)), 0.0, 0.0, gate_b),
		...
		Role@ MTFCom = Role(ROLE_MTF_COMMANDER, "Капитан Мобильной Оперативной Группы", CATEGORY_SECURITY, PlayerModel(MTF_MODEL, {MTF_COMMANDER_TEXTURE}), Color(20, 20, 200), "Найди и спаси учёных. Арестуй или нейтрализуй Класс-Д. Командуй своим отрядом.",
		{ 
			Spawnpoint(vector3(frand(4000.0, 4800.0), 50, frand(-5300.0, -4600.0)), 0.0, 0.0, gate_b),
			Spawnpoint(vector3(frand(4000.0, 4800.0), 50, frand(-5300.0, -4600.0)), 0.0, 0.0, gate_b),
			Spawnpoint(vector3(frand(4000.0, 4800.0), 50, frand(-5300.0, -4600.0)), 0.0, 0.0, gate_b),
		...
		Role@ Chaos = Role(ROLE_CHAOS, "Рекрут Повстанцев Хаоса", CATEGORY_INMATE, PlayerModel(CHAOS_MODEL), Color(26, 64, 1), "Найди и спаси Класс-Д. Арестуй или нейтрализуй персонал фонда.",
		{ 
		...
		Role@ ChaosMed = Role(ROLE_CHAOS_MEDIC, "Медик Повстанцев Хаоса", CATEGORY_INMATE, PlayerModel(CHAOS_MODEL), Color(26, 64, 1), "Найди и спаси Класс-Д. Арестуй или нейтрализуй персонал фонда. Лечи свой отряд.",
		{ 
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
		...
		Role@ ChaosSer = Role(ROLE_CHAOS_GUNNER, "Пулемётчик Повстанцев Хаоса", CATEGORY_INMATE, PlayerModel(CHAOS_MODEL), Color(26, 64, 1), "Найди и спаси Класс-Д. Арестуй или нейтрализуй персонал фонда.",
		{ 
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
		...
		Role@ ChaosCom = Role(ROLE_CHAOS_COMMANDER, "Капитан Повстанцев Хаоса", CATEGORY_INMATE, PlayerModel(CHAOS_MODEL), Color(26, 64, 1), "Найди и спаси Класс-Д. Арестуй или нейтрализуй персонал фонда. Командуй своим отрядом.",
		{ 
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
		...
		Role@ GOC = Role(ROLE_GOC, "Оперативник Глобальной Оккультной Коалиции", CATEGORY_GOC, PlayerModel(GOC_MODEL, {GOC_TEXTURE}), Color(89, 148, 229), "Ликвидируй всех в фонде.",
		{ 
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
		...
		Role@ scp173 = Role(ROLE_SCP_173, "SCP-173", CATEGORY_ANOMALY, PlayerModel(SCP_173_MODEL), Color(200, 0, 0), "Убей всех. Жди 45 секунд чтобы двигаться.",
		{
			Spawnpoint(vector3(0, 78, 0), 0.0, 0.0, cont1_173)
		}, {}, true, 0.0, 12000, 1, true);
		
		Role@ scp049 = Role(ROLE_SCP_049, "SCP-049", CATEGORY_ANOMALY, PlayerModel(SCP_049_MODEL), Color(200, 0, 0), "'Излечи' всех. Жди 45 секунд чтобы двигаться.",
		{
			Spawnpoint(vector3(0, 83, 597), 0.0, 0.0, world.GetRoomByIdentifier(r_cont2_049))
		}, {}, true, 0.0, 10000, 8, true);
		
		Role@ scp106 = Role(ROLE_SCP_106, "SCP-106", CATEGORY_ANOMALY, PlayerModel(SCP_106_MODEL), Color(200, 0, 0), "Убей всех. Жди 45 секунд чтобы двигаться.",
		{
			Spawnpoint(vector3(-132, 83, -704), 0.0, 0.0, world.GetRoomByIdentifier(r_cont1_106))
		}, {}, true, 4.0, 8750, 1.5, true);
		
		Role@ scp939 = Role(ROLE_SCP_939, "SCP-939", CATEGORY_ANOMALY, PlayerModel(SCP_939_MODEL), Color(200, 0, 0), "Убей всех. Жди 45 секунд чтобы двигаться.",
		{
		...
		Role@ scp966 = Role(ROLE_SCP_966, "SCP-966", CATEGORY_ANOMALY, PlayerModel(SCP_966_MODEL), Color(200, 0, 0), "Убей всех. Жди 45 секунд чтобы двигаться.",
		{
		...
		Role@ scp096 = Role(ROLE_SCP_096, "SCP-096", CATEGORY_ANOMALY, PlayerModel(SCP_096_MODEL), Color(200, 0, 0), "Убей всех. Жди 45 секунд чтобы двигаться.",
		{
			Spawnpoint(vector3(-1368, 78.0, 368), 0.0, 0.0, room2_servers_hcz)
		}, {}, true, 0.01, 5600, 0.75, true);
		
		Role@ scp860 = Role(ROLE_SCP_860, "SCP-860-2", CATEGORY_ANOMALY, PlayerModel(SCP_860_MODEL), Color(200, 0, 0), "Убей всех. Жди 45 секунд чтобы двигаться.",
		{
		...
		Role@ Ghost = Role(ROLE_GHOST, "Призрак", CATEGORY_STALEMATE, PlayerModel(CLASS_D_MODEL), Color(212,113,0), "", {Spawnpoint(vector3(-2874.0, 470, 9366.3), 0.0, -90.0, cont1_173)}, {}, false, 1.0, 20000, 0.0, true);
		...
		for(int i = 0; i < roles.size(); i++) {
			for(int t = 0; t < roles.size(); t++) {
				...
				if(roles[i].name.findFirst("Повстанцев Хаоса") >= 0 && roles[t].name.findFirst("Повстанцев Хаоса") >= 0) roles[i].SetRelative(roles[t]);
				if(roles[i].name.findFirst("Мобильной Оперативной Группы") >= 0 && roles[t].name.findFirst("Мобильной Оперативной Группы") >= 0) roles[i].SetRelative(roles[t]);
			}
		}
		...
		AddCategory(Category(CATEGORY_STALEMATE, "Заключённые", Color(200, 200, 200)));
		AddCategory(Category(CATEGORY_INMATE, "Класс-Д и " + Color(26, 64, 1).GetFormat() + "ПХ", Color(212, 113, 0)));
		AddCategory(Category(CATEGORY_STAFF, "Сотрудники Фонда", Color(200, 200, 200)));
		AddCategory(Category(CATEGORY_SECURITY, "Охрана", Color(47, 80, 255)));
		AddCategory(Category(CATEGORY_ANOMALY, "SCPs", Color(200, 0, 0)));
		AddCategory(Category(CATEGORY_GOC, "ГОК", Color(89, 148, 229)));
